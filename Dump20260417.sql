...
INSERT INTO `Ingredientes` VALUES (1,'wefw',12);
...
CREATE TABLE `Relacion` (
  ...
  CONSTRAINT `fk_Ingredientes` FOREIGN KEY (`idRelacion`) REFERENCES `Ingredientes` (`idIngredientes`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_Recetas` FOREIGN KEY (`idRelacion`) REFERENCES `Recetas` (`idRecetas`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-04-17 17:23:49
